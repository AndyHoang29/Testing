<template>
  <v-stepper v-model="e1">
    <v-stepper-header>
      <v-stepper-step :complete="e1 > 1" step="1" color="deep-purple lighten-4">
        I am physically...
      </v-stepper-step>
      <v-divider></v-divider>
      <v-stepper-step :complete="e1 > 2" step="2" color="deep-purple lighten-4">
        I am mentally...
      </v-stepper-step>
      <v-divider></v-divider>
      <v-stepper-step step="3" color="deep-purple lighten-4">
        I am emotionally...
      </v-stepper-step>
    </v-stepper-header>
      ...
      <v-stepper-items>
        <v-stepper-content class="content" step="1">
          <v-container class="main-content">
            ...
            <v-btn dark color="#8675a9" @click="e1 = 2"> Continue </v-btn>
        ...
        <v-stepper-content class="content" step="2">
          <v-container class="main-content">
            ...
            <v-btn dark color="#8675a9" @click="e1 = 3"> Continue </v-btn>
        ...
        <v-stepper-content class="EmotionalContent" step="3">
          ...
          <v-container class="negative-content">
            ...
            <v-btn dark color="#8675a9" @click="SaveDailyCheckIn()"> Continue </v-btn>
            <v-btn text href="./"> Cancel </v-btn>    
        </v-stepper-content>
      </v-stepper-items>
    </v-container>
