              ...
              <v-container class="text-center">
                <form @submit.prevent="onSubmit" ref="form">
                  ...
                  >
                    ...
                    sm="6"
                    >
                     <v-select :items="items" outlined v-model="newgoal.goalType" placeholder="Select Goal Type" color="purple darken-2">
                  </v-select>
                    </v-col>
                   <v-col cols="12">
                  <v-textarea
                  ...
                  <v-btn type="submit" dark depressed class="purple darken-2" rounded block >
                ...
                <div class="goals">
                  <v-card v-for="goal in allGoals" :key="goal.id">
                    <v-toolbar class="goal" flat dark color="purple darken-2">
