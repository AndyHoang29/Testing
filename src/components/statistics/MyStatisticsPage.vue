      ...
      <v-row>
        <v-col>
              <v-container  id="diaryLogs" style="display:none;">
                <div class="diaryLogs">
                  <v-card flat max-width="344" v-for="diaryLog in allDiaryLogs" :key="diaryLog.id">
...
export default {
  ...
  methods: {
    ...
    fillPieData() {
      this.pieData = {
        labels: ["All Goals", "CompletedGoals", "Incompleted Goals"],
        datasets: [
          {
            label: "Data",
            data: [
            ...
            backgroundColor: ["#fdcfdf", "#f9f7cf", "#120078"],
          },
        ],
      };
    },
